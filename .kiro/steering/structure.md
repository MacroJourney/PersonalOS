...
| 文档 | 用途 |
|------|------|
| `docs/architecture/三区框架.md` | 理解三区工作空间设计 |
| `docs/architecture/PDCA系统.md` | 理解三层 PDCA 循环 |
| `docs/architecture/AI数字分身.md` | 理解 AI 配置原理 |
...
4. **章节锚点**：
   ```markdown
   参考 [三区框架](docs/architecture/三区框架.md#核心理念)
   ```
...
5. **第 2-3 月**：深入阅读 `docs/architecture/` 理解设计
