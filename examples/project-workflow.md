...
本文档展示如何在 PersonalOS 中管理项目的完整生命周期，从启动到归档。
...
### 后续行动
- [ ] 将项目笔记归档到 `Efforts/Projects/Archive/`
- [ ] 提取的模板和技能已创建
...
另外，建议将本项目笔记归档到 `Efforts/Projects/Archive/2026/`，
...
```
01_Shared/Efforts/Projects/Archive/
└── 2026/
    └── 个人网站重构.md
```
